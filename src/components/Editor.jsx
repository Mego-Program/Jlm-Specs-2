...
export default function TEditor(props) {
  ...
  const addTask = () => {
    ...
    props.func(contentObject.blocks, props.item)
    cancelTask()
  }
  ...
  return (
    <React.Fragment key={"top"}>
      ...
      >
        <Box
          sx={{ bgcolor: "background.b1", width: "100vw" }}
          role="presentation"
        >
      ...
      >
        ...
        >
          ...
          <Button
            ...
            onClick={addTask}
          >
            {props.info.blocks.length == 0 ? (
                <Typography sx={{fontWeight:700, fontSize:14}}>Add Task</Typography>
            ):(
                <Typography sx={{fontWeight:700, fontSize:14}}>Update task</Typography>
            )}
          </Button>
      </Box>
        </Box>
